...
(async function () {
	...
	model = await tf.loadModel('http://skin.test.woza.work/final_model_kaggle_version1/model.json'); // adresse du model que l'on utilise, en ligne pour le moment, peut être placé côté utilisateur
